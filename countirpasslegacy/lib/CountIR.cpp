...
bool CountIRLegacyPass::runOnFunction(llvm::Function &F)
{
    runCounting(F);
    return false;
}
...
void CountIRLegacyPass::getAnalysisUsage(llvm::AnalysisUsage &AU) const
{
    AU.setPreservesAll();
}
...
static RegisterPass<CountIRLegacyPass> X("my-legacy-countir", "CountIR Pass");