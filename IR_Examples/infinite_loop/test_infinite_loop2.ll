; ModuleID = 'test_infinite_loop2.bc'
...
define dso_local void @_Z5ojetev() local_unnamed_addr #5 {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_test_infinite_loop.cpp() #0 section ".text.startup" {
entry:
