; ModuleID = 'example_string.cpp'
source_filename = "example_string.cpp"
...
@.str = private unnamed_addr constant [10 x i8] c"cacafuti\0A\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"farenain\00", align 1
@_ZTISt13runtime_error = external constant ptr
@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str.2 = private unnamed_addr constant [26 x i8] c"An exception has ocurred\0A\00", align 1
@.str.3 = private unnamed_addr constant [13 x i8] c"Value of d: \00", align 1
@.str.4 = private unnamed_addr constant [42 x i8] c"basic_string::_M_construct null not valid\00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_example_string.cpp, ptr null }]
...
define dso_local void @_Z9retvectorB5cxx11i(ptr noalias sret(%"class.std::__cxx11::basic_string") align 8 %agg.result, i32 noundef %b) #4 personality ptr @__gxx_personality_v0 {
entry:
...
invoke.cont2:                                     ; preds = %if.then
  invoke void @__cxa_throw(ptr %exception, ptr @_ZTISt13runtime_error, ptr @_ZNSt13runtime_errorD1Ev) #11
...
entry:
  ...
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1Ev(ptr noundef nonnull align 8 dereferenceable(32) %d) #3
  invoke void @_Z9retvectorB5cxx11i(ptr sret(%"class.std::__cxx11::basic_string") align 8 %ref.tmp, i32 noundef 0)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  %call = call noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_(ptr noundef nonnull align 8 dereferenceable(32) %d, ptr noundef nonnull align 8 dereferenceable(32) %ref.tmp) #3
...
lpad:                                             ; preds = %entry
  ...
  %call3 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.2)
          to label %invoke.cont2 unwind label %lpad1

invoke.cont2:                                     ; preds = %catch
  %call5 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.3)
          to label %invoke.cont4 unwind label %lpad1

invoke.cont4:                                     ; preds = %invoke.cont2
  %call7 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsIcSt11char_traitsIcESaIcEERSt13basic_ostreamIT_T0_ES7_RKNSt7__cxx1112basic_stringIS4_S5_T1_EE(ptr noundef nonnull align 8 dereferenceable(8) %call5, ptr noundef nonnull align 8 dereferenceable(32) %d)
...
try.cont:                                         ; preds = %invoke.cont9, %invoke.cont
  store i32 0, ptr %retval, align 4
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(ptr noundef nonnull align 8 dereferenceable(32) %d) #3
  %4 = load i32, ptr %retval, align 4
  ret i32 %4

lpad1:                                            ; preds = %invoke.cont4, %invoke.cont2, %catch
...
invoke.cont10:                                    ; preds = %lpad1
  br label %ehcleanup

ehcleanup:                                        ; preds = %invoke.cont10, %lpad8
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(ptr noundef nonnull align 8 dereferenceable(32) %d) #3
  br label %eh.resume
...
define linkonce_odr dso_local noundef zeroext i1 @_ZN9__gnu_cxx11char_traitsIcE2eqERKcS3_(ptr noundef nonnull align 1 dereferenceable(1) %__c1, ptr noundef nonnull align 1 dereferenceable(1) %__c2) #9 comdat align 2 {
entry:
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef zeroext i1 @_ZN9__gnu_cxx17__is_null_pointerIKcEEbPT_(ptr noundef %__ptr) #9 comdat {
entry:
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_example_string.cpp() #0 section ".text.startup" {
entry:
